...
int Construible::construirEdificio(Edificio* edificio){
    ...
    if(!this->edificio){
        ...
        //Obtendo sus datos
        string nombre = edificio->devolver_nombre();
        int cantPiedra = edificio->devolver_piedra();
        int cantMadera = edificio->devolver_madera();
        int cantMetal = edificio->devolver_metal();
        int cantMaxPermitidos = edificio->devolver_cant_maxima_edificios();
